...
INPUT_FILE_NAME = "disney-characters.csv"
...
def prepare_message_from_row(row):
    ...
    Movie, Release, Hero, Villian, Song = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{Movie}, {Release}, {Hero}, {Villian}, {Song}]"
...
def stream_row(input_file_name, address_tuple, output_file_name):
    ...
    with open(input_file_name, "r") as input_file:
        ...
        with open(output_file_name, "w", newline="") as output_file:
            ...
            writer.writerow(['Movie', 'Release', 'Hero', 'Villian', 'Song'])
